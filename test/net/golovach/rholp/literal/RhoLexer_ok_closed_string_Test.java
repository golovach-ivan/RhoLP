...
public class RhoLexer_ok_closed_string_Test {
    ...
    public void test_with_env_len_0() {
        ...
        assertThat(tokenize(content), is(asList(
                TRUE, PLUS, LITERAL_STRING, DIV, LITERAL_INT, EOF)));
    ...
    public void test_json() {
        ...
        assertThat(tokenize(content), is(asList(
                LBRACE, LITERAL_STRING, COLON, LITERAL_STRING, RBRACE, EOF)));
    ...
    public void test_uri() {
        ...
        assertThat(tokenize(content), is(asList(
                NEW, IDENT, LPAREN, LITERAL_STRING, RPAREN, IN, LBRACE, NIL, RBRACE, EOF)));
